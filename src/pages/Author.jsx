        ...
        {loading || !author ? (
          ...
          <>
            <section
              id="profile_banner"
              aria-label="section"
              className="ske-banner ske-shimmer"
              data-bgimage="url(images/author_banner.jpg) top"
              />
            <section aria-label="section" className="main_wrapper">
                      ...
                      <div className="de-flex-col">
                        <div className="profile_avatar">
                          ...
                          <div className="profile_name">
                            <h4>
                              <span className="ske-line ske-shimmer" />
                              ...
                              <span className="ske-btn ske-shimmer" />
                            </h4>
                          </div>
                        </div>
                      </div>
